...
using Constants = _18_02_2021_University_manager.Helpers.Constants;
...
namespace _18_02_2021_University_manager.Areas.Student.Controllers
{
    ...
    public class ManageController : Controller
    {
        ...
        public async Task<ActionResult> Index(ManageMessageId? message)
        {
            ...
            var st = ctx.Students.FirstOrDefault(u => u.Id == user.Student.Id);
            var model = new IndexViewModel
            {
                StudentId = st.Id,
                FirstName = st.FirstName,
                SecondName = st.SecondName,
                Email = st.ApplicationUser.Email,
                Image = st.Image,
        ...
        [HttpPost]
        public ActionResult Edit(IndexViewModel pt, HttpPostedFileBase imageFile)
        {
            if (imageFile != null)
            {
                ...
                using (Bitmap bmp = new Bitmap(imageFile.InputStream))
                {
                    ...
                    if (saveImage != null)
                    {
                        ...
                        Models.Entity.Models.Student p = ctx.Students.Find(pt.StudentId);
                        p.Id = pt.StudentId;
