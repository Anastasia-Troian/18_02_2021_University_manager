...
namespace _18_02_2021_University_manager.Controllers
{
    [Authorize]
                ...
                case SignInStatus.Success:
                    ...
                    foreach (var role in roles)
                    {
                        switch (role)
                        {
                            ...
                            case "Student":
                                return RedirectToAction("GroupList", "Group", new { area = "Student" });
                            case "User":
                ...
                if (result.Succeeded)
                {
                    ...
                    using (Bitmap bmp = new Bitmap(imageFile.InputStream))
                    {
                        ...
                        if (saveImage != null)
                        {
                            ...
                            {
                                ApplicationUser = ctx.Users.FirstOrDefault(x => x.Email == model.Email),
